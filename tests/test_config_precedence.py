...
CONFIG_ENV_VARS = [
    ...
    "TRANSCRIPTION_PROMPT_FILE",
    "OPENAI_TRANSCRIPTION_PROMPT_FILE",
...
YAML_VALUES: dict[str, Any] = {
    ...
    "transcriptions_path": "yaml_transcriptions.json",
    "diarization_enabled": True,
    "gpu_enabled": False,
    "denoising_enabled": False,
    "langsmith_tracing": True,
    "extractor_prompt_file": "yaml_prompt.yaml",
    "transcription_prompt_file": "yaml_whisperx_prompt.yaml",
    "openai_transcription_prompt_file": "yaml_openai_prompt.yaml",
...
DOTENV_VALUES: dict[str, Any] = {
    ...
    "sample": "all",
    "extraction_only": True,
    "transcriptions_path": "dotenv_transcriptions.json",
    "diarization_enabled": False,
    "gpu_enabled": False,
    "denoising_enabled": False,
    "langsmith_tracing": False,
    "extractor_prompt_file": "dotenv_prompt.yaml",
    "transcription_prompt_file": "dotenv_whisperx_prompt.yaml",
    "openai_transcription_prompt_file": "dotenv_openai_prompt.yaml",
...
INIT_VALUES: dict[str, Any] = {
    ...
    "transcriptions_path": "init_transcriptions.json",
    "diarization_enabled": True,
    "gpu_enabled": True,
    "denoising_enabled": True,
    "langsmith_tracing": True,
    "extractor_prompt_file": "init_prompt.yaml",
    "transcription_prompt_file": "init_whisperx_prompt.yaml",
    "openai_transcription_prompt_file": "init_openai_prompt.yaml",
